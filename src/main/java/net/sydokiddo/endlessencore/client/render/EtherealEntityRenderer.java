...
public class EtherealEntityRenderer extends HumanoidMobRenderer<Mob, EtherealEntityModel<Mob>> {
    ...
    public EtherealEntityRenderer(Context ctx, ModelLayerLocation layer, ModelLayerLocation innerArmorLayer, ModelLayerLocation outerArmorLayer) {
        ...
        this.addLayer(new EtherealEyesFeatureRenderer<>(this));
    }
