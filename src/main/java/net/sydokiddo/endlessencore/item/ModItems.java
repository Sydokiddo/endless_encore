...
public class ModItems {
    ...
    .food(new FoodComponent.Builder().alwaysEdible().hunger(6).saturationModifier(10)
    .statusEffect(new StatusEffectInstance(StatusEffects.SLOW_FALLING, 160, 0), 1f).build())
