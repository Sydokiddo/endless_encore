...
public class DamageEnchantment extends Enchantment {
    ...
    public DamageEnchantment(Rarity weight, int typeIndex, EquipmentSlot... slots) {
    ...
    public boolean isAcceptableItem(ItemStack stack) {
        return stack.getItem() instanceof AxeItem || (super.isAcceptableItem(stack) && stack.getItem() instanceof SickleItem || super.isAcceptableItem(stack));
    }
